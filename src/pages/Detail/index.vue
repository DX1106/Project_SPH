    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <ZoomShow :skuImageList="skuImageList" />
          <!-- 小图列表 -->
...
import ZoomShow from "./Zoom/Zoom";
...
export default {
  ...
  methods: {
    ...
    async addShopcar() {
      ...
      /*
        当前这里是派发了一个action，也向服务器发请求,判断加入购物车是成功还是失败了,进行相应的操作
        下面这行代码：调用仓库中的addOrUpdateShopCart,这个方法加上async，返回一定是一个Promise
      */
      try {
